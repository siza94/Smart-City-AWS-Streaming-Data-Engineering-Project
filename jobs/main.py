...
def simulated_vehicle_movement():
    ...
    #add some randomness to simulate actual vehicle travel
...
def simulated_journey(producer, device_id):
    while True:
        vehicle_data = generate_vehicle_data(device_id)
        gps_data =  generate_gps_data(device_id, vehicle_data['timestamp'])
        traffic_camera_data = generate_traffic_camera_data(device_id, vehicle_data['timestamp'], vehicle_data['location'], 'Nikon-DC8725')
        ...
        if (vehicle_data['location'][0] >= BIRMINGHAM_COORDINATES['latitude']
            ...
            print('The vehicle has reached the destination Birmingham. The simulation is ending...')
            break
...
if __name__ == '__main__':
    ...
    try:
        simulated_journey(producer, 'Vehicle-123')
